...
export function ImpactSection() {
  return (
    <section className="py-24 relative overflow-hidden bg-navy-950/50 border-y border-white/[0.08]">
      ...
      <div className="absolute top-1/2 left-1/4 w-[600px] h-[300px] bg-cyan/10 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[600px] h-[300px] bg-electric-violet/10 blur-[140px] rounded-full pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SectionHeading
          badge="OUR COMMUNITY MILESTONES"
          title="Measured by Real"
          highlightText="Impact & Outcomes"
          description="We focus on genuine student engagement, practical coding workshops, and helping college developers launch projects and careers."
        />
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  {metric.isVerified && (
                    <span className="flex items-center gap-1.5 text-[10px] font-mono text-emerald-400 bg-emerald-950/50 border border-emerald-500/40 px-2.5 py-1 rounded-full backdrop-blur-md font-bold">
              ...
              <div className="mt-6 pt-4 border-t border-white/[0.06] text-[11px] font-mono text-slate-400 flex items-center justify-between">
                ...
                <span className="text-cyan font-semibold">Active Chapters</span>
              </div>
            </SpotlightCard>
          ))}
        </div>

        {/* Footnote on Campus Ambassador Program */}
        <div className="mt-12 p-6 sm:p-8 rounded-3xl bg-white/[0.03] backdrop-blur-2xl border border-white/[0.1] shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.12),0_15px_35px_-10px_rgba(0,0,0,0.5)] flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-3 h-3 rounded-full bg-cyan animate-pulse shrink-0 shadow-[0_0_10px_rgba(0,229,255,0.8)]" />
            <p className="text-xs sm:text-sm text-slate-200 font-medium">
              <strong className="text-cyan">Campus Ambassador Program 2026:</strong> Onboarding student leaders and hackathon coordinators across 50+ Indian colleges.
            </p>
          </div>
          <Link
            href="/community"
          ...
          >
            Apply for CAP 2026 <ArrowUpRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    </section>
