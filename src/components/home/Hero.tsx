...
export function Hero() {
  return (
    <section className="relative min-h-[92vh] pt-28 sm:pt-32 pb-16 sm:pb-20 overflow-hidden flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        >
          <div className="flex flex-wrap sm:inline-flex items-center justify-center gap-1.5 sm:gap-2.5 px-4 sm:px-5 py-2 rounded-full bg-white/[0.05] backdrop-blur-2xl border border-white/[0.12] text-[11px] sm:text-xs font-mono text-cyan shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.18),0_10px_30px_-5px_rgba(0,229,255,0.2)] text-center">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-300 max-w-3xl mx-auto font-normal leading-relaxed">
        ...
        >
          {/* Pillar 1: LEARN */}
          <SpotlightCard glowColor="cyan" className="p-6 sm:p-8 bg-navy-950/60 flex flex-col justify-between">
            <div>
          ...
          {/* Pillar 2: BUILD */}
          <SpotlightCard glowColor="violet" className="p-6 sm:p-8 bg-navy-950/60 flex flex-col justify-between">
            <div>
        ...
        <motion.div
          ...
          className="rounded-3xl bg-navy-950/60 border border-white/[0.08] p-6 sm:p-8 backdrop-blur-2xl shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.1),0_20px_45px_-10px_rgba(0,0,0,0.6)] grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center relative overflow-hidden"
        >
          ...
          <div>
            ...
            <span className="text-[10px] sm:text-xs font-mono text-slate-400 uppercase tracking-wider mt-1 block">Active Learners</span>
          </div>

          <div>
            <span className="text-2xl sm:text-4xl font-extrabold text-foreground font-display block">10+</span>
            <span className="text-[10px] sm:text-xs font-mono text-slate-400 uppercase tracking-wider mt-1 block">Hackathons & Sprints</span>
          </div>

          <div>
            <span className="text-2xl sm:text-4xl font-extrabold text-foreground font-display block">100+</span>
            <span className="text-[10px] sm:text-xs font-mono text-slate-400 uppercase tracking-wider mt-1 block">Partner Communities</span>
          </div>

          <div>
            <span className="text-2xl sm:text-4xl font-extrabold text-cyan font-display block">₹2,00,000+</span>
            <span className="text-[10px] sm:text-xs font-mono text-slate-400 uppercase tracking-wider mt-1 block">Prize Pool Awarded</span>
          </div>
        </motion.div>
      </div>
    </section>
