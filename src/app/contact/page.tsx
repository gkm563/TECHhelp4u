      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="rounded-3xl bg-white/80 dark:bg-navy-950/50 border border-slate-200/80 dark:border-white/[0.08] p-6 sm:p-8 backdrop-blur-2xl shadow-sm dark:shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.1),0_15px_35px_-10px_rgba(0,0,0,0.5)] relative overflow-hidden">
              ...
              <div className="space-y-6 text-sm">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-2xl bg-cyan-50 dark:bg-cyan/10 border border-cyan-200 dark:border-cyan/30 flex items-center justify-center text-cyan-700 dark:text-cyan shrink-0 backdrop-blur-md shadow-sm dark:shadow-[0_0_15px_rgba(0,229,255,0.2)]">
                  ...
                  <div>
                    ...
                    <a href="tel:+919238253996" className="text-slate-800 dark:text-slate-200 font-medium font-mono hover:text-cyan-700 dark:hover:text-cyan transition-colors">
                      +91 9238253996
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-cyan-700 dark:text-cyan font-mono text-xs font-bold">
            ...
            {/* Social Gateways */}
            <div className="rounded-3xl bg-white/80 dark:bg-navy-950/50 border border-slate-200/80 dark:border-white/[0.08] p-6 sm:p-8 backdrop-blur-2xl shadow-sm dark:shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.1)]">
              <h4 className="text-xs font-mono uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-4 font-semibold">
              ...
              <div className="grid grid-cols-2 gap-3">
                {socialLinks.map((item) => (
                  <a
                    ...
                    className="p-3.5 rounded-2xl bg-slate-50 dark:bg-white/[0.03] backdrop-blur-md border border-slate-200 dark:border-white/[0.07] hover:border-cyan-500/40 dark:hover:border-cyan/40 hover:bg-slate-100 dark:hover:bg-white/[0.06] hover:text-cyan-700 dark:hover:text-cyan text-xs font-mono text-slate-700 dark:text-slate-300 transition-all flex items-center justify-between shadow-sm"
                  >
                    <span>{item.name}</span>
          ...
          <div className="lg:col-span-7">
            <div className="rounded-3xl bg-white/90 dark:bg-navy-950/60 border border-slate-200/90 dark:border-white/[0.1] p-6 sm:p-10 lg:p-12 backdrop-blur-2xl shadow-sm dark:shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.15),0_25px_60px_-15px_rgba(0,0,0,0.8)] relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-cyan-500/40 dark:via-cyan/40 to-transparent pointer-events-none" />
              
              {submitted ? (
                <div className="py-12 text-center space-y-4">
                  <div className="w-16 h-16 rounded-2xl bg-cyan-50 dark:bg-cyan/10 border border-cyan-200 dark:border-cyan/40 flex items-center justify-center text-cyan-700 dark:text-cyan mx-auto backdrop-blur-md shadow-sm dark:shadow-[0_0_25px_rgba(0,229,255,0.3)]">
