  ...
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 6-Month Pilot Target Strip */}
        <div className="rounded-3xl bg-navy-850 border border-slate-800 p-6 sm:p-8 mb-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <span className="text-3xl sm:text-4xl font-extrabold text-cyan font-display">50</span>
            <span className="text-xs font-mono text-slate-400 block mt-1 uppercase">Partner Colleges</span>
          </div>
          <div>
            <span className="text-3xl sm:text-4xl font-extrabold text-cyan font-display">100</span>
          ...
          <div>
            <span className="text-3xl sm:text-4xl font-extrabold text-cyan font-display">10,000+</span>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {tiers.map((tier) => (
              <div
                key={tier.name}
                className="rounded-3xl bg-navy-850/80 border border-slate-800 p-8 backdrop-blur-md hover:border-cyan/40 transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className="text-xs font-mono font-bold tracking-wider uppercase px-2.5 py-1 rounded border"
                      style={{
                        color: tier.color,
                ...
                <div className="mt-8 pt-6 border-t border-slate-800">
                  <a
                    href="#apply"
                    className="w-full py-2.5 rounded-xl border text-xs font-mono font-bold uppercase tracking-wider flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform"
                    style={{
        ...
        <div id="apply" className="rounded-3xl bg-navy-850 border border-slate-800 p-8 sm:p-12 relative overflow-hidden">
          <div className="max-w-2xl mx-auto">
            ...
            {applied ? (
              <div className="p-8 rounded-2xl bg-cyan/10 border border-cyan/40 text-center">
